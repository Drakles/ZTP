...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        sb.setName("Janko").setSurname("Muzykant").setId(1).setCourses(courseList).setAge(23);
        courseList.add(new Course("Podstawy programownania"));

        students.add(sb.createStudent());

        sb.setName("Klaudia").setSurname("Marciniak").setId(2).setGender(Gender.FEMALE).setAge(20);
